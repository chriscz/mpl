...
public class Log {
    ...
    /** Use colours when logging */
    static private boolean USE_COLOURS = false;

    /* Standard logging colours */
    private static class Colors {
        static final String ERROR = "\033[91m";
        static final String WARN  = "\033[93m";
        static final String INFO  = "\033[94m";
        static final String DEBUG = "\033[92m";
        static final String TRACE = "\033[95m";
    ...
    static public void setUseColours(boolean useColours) {
    ...
    static public class Logger {
        ...
        public void log(int level, String category, String message, Throwable ex) {
            ...
            if (USE_COLOURS) {
                switch (level) {
                    case LEVEL_ERROR:
                        builder.append(Colors.ERROR);
                        break;
                    case LEVEL_WARN:
                        builder.append(Colors.WARN);
                        break;
                    case LEVEL_INFO:
                        builder.append(Colors.INFO);
                        break;
                    case LEVEL_DEBUG:
                        builder.append(Colors.DEBUG);
                        break;
                    case LEVEL_TRACE:
                        builder.append(Colors.TRACE);
                        break;
                }
            }
            switch (level) {
